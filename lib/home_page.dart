      ...
      body: ListView(
        children: <Widget>[
          ...
          MaterialButton(
              ...
              child: Text('Artikel Kuliner Bali'),
              onPressed: () {
                Navigator.push(
                  context,
          ...
          MaterialButton(
              ...
              color: Colors.white,
              textColor: Colors.black,
              child: Text('Ayam Bakar Taliwang'),
              onPressed: () {
                Navigator.push(
                  context,
...
class HalamanKedua extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Artikel Kuliner Bali"),
          backgroundColor: Colors.purple.shade300,
        ),
...
class HalamanKetiga extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Ayam Bakar Taliwang"),
          backgroundColor: Colors.purple.shade300,
        ),
        body: Stack(
          children: <Widget>[
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      AlertDialog alert = AlertDialog(
                        ...
                        content: Container(
                          child: Text("Tunggu pesanan sampai di rumah ya! Terimakasih :)"),
                        ),
                        actions: [
                          TextButton(
                            child: Text('Ok'),
